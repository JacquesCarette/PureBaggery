...
\quad
\begin{array}[c]{l}
\F{Input}\: (\branch{\V{S}}{\V{P}}) \;=\; \VERTFPI{\V{S}}{\LAM{s}{\F{Input}\:(\V{P}\:\V{s})}}
\\
...
\[
\F{Input}\: (\branch{\V{S}}{\V{P}}) \;=\; \BLEUFPI{\V{S}}{\LAM{s}{\F{Input}\:(\V{P}\:\V{s})}}
\]
