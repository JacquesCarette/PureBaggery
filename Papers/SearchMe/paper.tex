...
\[
\VERTPI{(\FSG{\V{R}}{\V{S}})}{\V{T}}\quad =
\quad \VERTPI{\V{R}}{\LAM{r}{\VERTPI{\V{S}\:\V{r}}{\LAM{s}{\V{T}\:(\pr{\V{r}}{\V{s}})}}}}
\]
where our convention is that $\LAM{\cdot}{}$ scopes rightward as far as possible.
