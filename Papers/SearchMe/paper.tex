...
A lesson well worth learning from \citet{DBLP:journals/jar/McKinnaP99} is that data can admit newer and more convenient induction principles than those with which they were conceived. We may reorganise the recursive structure of data in much the way that \citet{DBLP:conf/popl/Wadler87} rearrange case analysis with `views'.
